...
export default function AppLayout() {
    ...
    <div className="px-4 py-5 border-b border-slate-800">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            onClick={() => fileRef.current?.click()}
            className="text-xs text-slate-400 hover:text-emerald-400 transition-colors truncate block"
          >
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 w-64 bg-slate-900 text-white z-50 flex flex-col transform transition-transform md:hidden ${
      ...
      <div className="flex-1 md:ml-64">
        ...
        <main className="p-4 md:p-6 lg:p-8 min-h-[calc(100vh-56px)] md:min-h-screen">
          <Outlet />
        </main>
      </div>
    </div>
